    ...
    public partial class SeedingDataForDifficulties : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("044a275e-7934-44f3-a905-7a345ea6d440"), "Easy" },
                    { new Guid("287b3639-e18a-4f6e-84f1-af30efebfc5e"), "Medium" },
                    { new Guid("a7f998dc-7206-4a6b-a004-cc1d7dedc589"), "Hard" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("044a275e-7934-44f3-a905-7a345ea6d440"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("287b3639-e18a-4f6e-84f1-af30efebfc5e"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("a7f998dc-7206-4a6b-a004-cc1d7dedc589"));
